...
//@ requires strings!= null && \nonnullelements(strings);
    ...
    public static class StringJoiner {
         ...
         */
//@ requires stringy!= null;
//@ ensures \result.append(separator).append(stringy);
...
//@ requires string!= null;
     ...
     */
//@ requires relUrl!= null;
//@ ensures \result.getProtocol() == protocol;
//@ ensures \result.getHost() == host;
//@ ensures \result.getPort() == port;
//@ ensures \result.toString() == relUrl;
     ...
     */
//@ requires baseUrl!= null && relUrl!= null;
//@ requires!(baseUrl.equals("") && relUrl.equals(""));
//@ ensures \result!= null;
...
//@ ensures \result.matcher(input).find();
