...
public class ParseSettings {
     ...
     */
//@ ensures \result == preserveTagCase;
     ...
     */
//@ ensures \result == preserveAttributeCase;
...
//@ ensures \result.isEmpty() ==> \result.value(normalize(attributes));
...
//@ ensures \result.equals(lowerCase(name.trim()));
