...
public class TokenQueue {
     ...
     */
//@ ensures \result <==> remainingLength() == 0;
...
//@ requires pos > 0;
     ...
     */
//@ ensures \result == queue.charAt(pos);
    public char consume() {
...
//@ requires seq!= null;
     ...
     */
//@ requires pos >= 0;
//@ requires start <= pos && start <= queue.size();
//@ requires close >= pos && close <= queue.size();
...
//@ ensures \result == (pos == 0);
     ...
     */
//@ requires start >= 0 && start <= queue.length();
//@ requires pos >= 0 && pos <= queue.length();
