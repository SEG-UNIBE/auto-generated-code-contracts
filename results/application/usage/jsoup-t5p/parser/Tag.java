...
//@ ensures \result == empty;
     ...
     */
//@ ensures \result == empty || selfClosing;
     ...
     */
//@ ensures \result == (tags.containsKey(tagName));
...
//@ ensures \result == (tags.containsKey(tagName));
     ...
     */
//@ ensures \result == preserveWhitespace;
...
//@ ensures \result == formList;
     ...
     */
//@ ensures \result == formSubmit;
    public boolean isFormSubmittable() {
        return formSubmit;
    }

//@ ensures selfClosing == true;
    Tag setSelfClosing() {
        selfClosing = true;
        return this;
    }
...
//@ requires formatAsBlock!= formatAsBlock;
//@ requires isBlock!= isBlock;
//@ requires preserveWhitespace!= preserveWhitespace;
//@ requires selfClosing!= selfClosing;
//@ requires formList!= formList;
    @Override
...
//@ requires tagName!= null;
//@ ensures  isBlock() == \old(isBlock) && formList() == \old(formList) && formSubmit() == \old(formSubmit);
//@ requires 0 <= first;
//@ requires 0 <= toCopy;
...
//@ ensures tags.containsKey(tag.tagName);
