...
//@ requires name!= null;
//@ requires nameKeys!= null;
//@ requires codeVals!= null;
...
//@ ensures \result == nameKeys.length;
        private int size() {
...
//@ requires accum!= null && string!= null;
//@ requires out!= null && out.escapeMode() == EscapeMode.xhtml;
//@ requires encoder!= null;
//@ requires coreCharset!= null;
//@ requires length > 0;
//@ ensures accum.append(string).append(length).append(characterSet);
...
//@ requires 0 <= codePoint && codePoint <= 255;
...
//@ ensures \result!= null;
     ...
     * Jsoup: 167, 2
     */
//@ ensures \result <==> (charset!= null && fallback!= null);
