...
//@ ensures  index == index;
    ...
    /**
     ...
     @since 1.14.2
     */
//@ ensures \result == hasAttributes()? attributes().size() : 0;
...
//@ ensures  attributes().containsKey(nodeName);
//@ requires 0 <= first;
//@ requires 0 <= toCopy;
...
//@ ensures isOpen;
     ...
     */
//@ requires 0 <= index;
//@ requires index < ensureChildNodes().size();
     ...
     */
//@ ensures \result.size() == \old(childNodeSize()) + 1;
     ...
     */
//@ ensures \result.size() == nodes.size();
...
//@ requires parentNode!= null;
     ...
     * @see #after(String)
     */
//@ requires 0 <= siblingIndex && siblingIndex < numChildren();
     ...
     */
//@ requires parentNode!= null;
//@ requires siblingIndex >= 0;
//@ ensures parentNode.addChildren(siblingIndex, node);
//@ ensures \result == this;
...
//@ requires parentNode!= null;
//@ requires siblingIndex >= 0;
//@ ensures parentNode.addChildren(siblingIndex + 1, node);
...
//@ requires parentNode!= null;
//@ ensures this.parentNode == parentNode;
//@ requires parentNode!= null;
//@ requires child!= null;
//@ ensures this.parentNode == parentNode;
//@ requires parentNode!= null;
...
//@ requires out.parentNode == this;
//@ requires in.parentNode!= null;
//@ requires out.siblingIndex == in.siblingIndex;
//@ ensures childNodes().set(out.siblingIndex, in);
...
//@ requires out!= null;
//@ requires this.siblingIndex == -1;
//@ ensures childNodes().length == 0;
//@ ensures out.parentNode == null;
//@ requires out.siblingIndex == -1;
//@ ensures childNodes() == null;
...
//@ ensures  \old(getChildren()) + children.length == \old(getChildren().length()) + 1;
...
//@ requires 0 <= index && index < childNodeSize();
...
//@ requires child!= null;
//@ ensures getParentNode() == child;
    protected void reparentChild(Node child) {
        child.setParentNode(this);
    }

//@ requires start >= 0;
//@ requires start <= childNodeSize();
...
//@ requires siblingIndex() == -1;
//@ ensures parent == siblingIndex;
    public int siblingIndex() {
        return siblingIndex;
    }

//@ requires 0 <= siblingIndex;
//@ ensures this.siblingIndex == siblingIndex;
...
//@ ensures \result == null || \result == ensureChildNodes().get(0);
...
//@ ensures \result!= null;
    ...
    /**
     ...
     @since 1.15.2
     */
//@ ensures \result.range().contains(this);
    public Range sourceRange() {
        return Range.of(this, true);
    }

    /** Test if this node is not null and has the supplied normal name. */
//@ ensures \result == (\exists Node node; node!= null; node.normalName().equals(""));
...
//@ ensures \result == (\exists String normalName;
//@ ensures \result!= null);
...
//@ ensures \result == super.hashCode();
     ...
     * @return true if the content of this node is the same as the other
     */
//@ ensures \result == (o == null || getClass()!= o.getClass());
...
//@ ensures \result == doClone(null);
     ...
     */
//@ requires parent!= null;
//@ ensures \result.parentNode == parent;
//@ ensures \result.siblingIndex == 0;
