...
//@ ensures \result == this!= Untracked;
     ...
     */
//@ requires node!= null;
//@ requires start || \invariant_for(node);
...
//@ requires start.equals(end);
     ...
     * @return a String
     */
//@ requires start >= 0 && start <= hauteur() && end >= 0 && end <= hauteur();
    @Override
...
//@ requires file!= null ==> file.length() > 0;
...
//@ requires file!= null ==> column_ > 0;
         ...
         * @return true if this was tracked during parsing, false otherwise (and all fields will be {@code -1}).
         */
//@ ensures \result == this!= UntrackedPos;
        public boolean isTracked() {
         ...
         * @return a String
         */
//@ ensures lineNumber == line_number && columnNumber == column_number && pos == pos;
        @Override
        public String toString() {
...
//@ requires pos!= null;
//@ requires lineNumber!= null;
//@ requires columnNumber!= null;
        @Override
        public boolean equals(Object o) {
            if (this == o) return true;
            if (o == null || getClass() != o.getClass()) return false;
