...
public class Attribute implements Map.Entry<String, String>, Cloneable  {
     ...
     */
//@ requires (this.key == null) || this.key.length() == 1;
//@ ensures (this.key == null) || this.key.length() == 2;
    @Override
...
//@ requires out!= null;
//@ requires validKey(key, out.syntax());
...
//@ requires accum!= null && out!= null;
//@ requires Attributes.checkNotNull(val)!= null;
...
//@ ensures \result!= null;
     ...
     * @return attribute
     */
//@ requires unencodedKey!= null;
//@ requires encodedValue!= null;
//@ ensures \result!= null;
...
//@ requires out!= null;
     ...
     */
//@ requires key!= null;
//@ requires \nonnullelements(booleanAttributes);
