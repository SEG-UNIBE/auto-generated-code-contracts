...
//@ requires ((this.key == null) || this.key.length() == 0) && (this.value == null);
        @Override
        public String toString() {
...
//@ requires ((this.key == null) || this.key.equals(key)) && (this.value == null || this.value.equals(value));
        @Override
        public String toString() {
            return String.format("[%s!=%s]", key, value);
        }
...
//@ requires ((this.key == null) || this.key.equals(value)) && (this.value == null || this.value.equals(value));
        @Override
        public String toString() {
            return String.format("[%s*=%s]", key, value);
        }
...
//@ requires 0 <= index;
//@ requires index <= Integer.MAX_VALUE;
        @Override
        public String toString() {
