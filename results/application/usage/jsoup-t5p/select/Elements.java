...
//@ requires 0 <= first;
//@ requires 0 <= toCopy;
//@ requires first + toCopy <= source.size();
    @Override
...
//@ ensures  \result.addAttribute(attributeName, attributeValue);
//@ ensures  \result.contains(attributeName);
...
//@ ensures \result.size() == this.size() - 1;
     ...
     */
//@ requires className!= null;
//@ ensures \result.contains(className);
     ...
     */
//@ requires className!= null;
//@ ensures \result == (element!= null && className!= null);
...
//@ requires query!= null;
     ...
     */
//@ requires siblings(null, true, false);
...
//@ requires query!= null;
     ...
     */
//@ requires siblings(null, true, true);
...
//@ requires query!= null;
     ...
     */
//@ requires siblings(null, false, false);
...
//@ requires query!= null;
     ...
     */
//@ requires siblings(null, false, true);
...
//@ ensures \result.size() == this.size() + next? 2 : 1;
...
//@ ensures \result.size() == NodeTraversor.maxDepth(nodeFilter);
