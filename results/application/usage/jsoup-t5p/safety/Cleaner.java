...
public class Cleaner {
     ...
     */
//@ ensures \result.outputSettings() == null;
//@ ensures \result.outputSettings().copy() == null;
//@ requires dirtyDocument!= null;
//@ ensures \result.outputSettings() == dirtyDocument.outputSettings();
     ...
     */
//@ ensures \result <==> dirtyDocument.head()!= null;
    ...
    /**
     ...
     @return true if no tags or attributes need to be removed; false if they do
     */
//@ ensures \result <==> clean.body().empty();
//@ ensures \result <==> dirty.body().empty();
