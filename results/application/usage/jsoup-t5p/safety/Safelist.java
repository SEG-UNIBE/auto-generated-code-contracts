...
//@ ensures \result!= null;
    ...
    /**
     ...
     @return safelist
     */
//@ ensures \result.addTags("img");
//@ ensures \result.addAttributes("img", "align", "alt", "height", "src", "title", "width");
//@ ensures \result.addProtocols("img", "src", "http", "https");
...
//@ ensures \result!= null;
     ...
     */
//@ requires tags!= null;
//@ ensures \result.tagNames().size() == tagNames.size() + 1;
     ...
     */
//@ requires tags!= null;
//@ ensures \result.tagNames().removeAll(tags);
//@ ensures \result.attributes().removeAll(tags);
//@ ensures \result.enforcedAttributes().removeAll(tags);
//@ ensures \result.protocols().removeAll(tags);
...
//@ ensures this.tagNames.size() == tagNames.size() + 1;
//@ ensures this.attributes.size() == attributeSet.size() + 1;
...
//@ requires value!= null;
//@ ensures \result.tagNames().contains(tag);
//@ ensures \result.enforcedAttributes().containsKey(tag);
//@ ensures \result.enforcedAttributes().get(tag) == \old(enforcedAttributes.get(tag));
//@ ensures \result.enforcedAttributes().remove(tag);
...
//@ requires attribute!= null;
     ...
     * @see #addProtocols
     */
//@ ensures preserveRelativeLinks == preserve;
    ...
    /**
     ...
     @return this, for chaining
     */
//@ requires protocols!= null;
//@ ensures \result.addProtocols(\result.getProtocols() + protocols);
...
//@ requires tag!= null;
//@ requires attribute!= null;
//@ requires \nonnullelements(removeProtocols);
...
//@ requires el!= null && attr!= null && protocols!= null;
//@ requires \nonnullelements(el.getElements());
...
//@ ensures \result == (value.startsWith("#") &&!value.matches(".*\\s.*"));
    private boolean isValidAnchor(String value) {
        return value.startsWith("#") && !value.matches(".*\\s.*");
    }

//@ requires tagName!= null;
//@ ensures \result.size() == enforcedAttributes.size() + 1;
...
//@ ensures \result.value().equals(value);
