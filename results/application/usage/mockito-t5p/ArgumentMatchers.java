...
public class ArgumentMatchers {
     ...
     * @see #anyBoolean()
     */
//@ ensures \result == null || \result.matches(Any.ANY);
     ...
     * @see #isNull()
     */
//@ ensures \result == defaultValue(type);
...
//@ requires true;
     ...
     * @see #isNull()
     */
//@ requires reportMatcher(new InstanceOf(Byte.class, "<any byte>"));
//@ ensures \result == 0;
     ...
     * @see #isNull()
     */
//@ requires reportMatcher(new InstanceOf(Character.class, "<any char>"));
//@ ensures \result == 0;
     ...
     * @see #isNull()
     */
//@ requires reportMatcher(new InstanceOf(Integer.class, "<any integer>"));
//@ ensures \result == 0;
     ...
     * @see #isNull()
     */
//@ requires reportMatcher(new InstanceOf(Long.class, "<any long>"));
//@ ensures \result == 0;
...
//@ requires true;
     ...
     * @see #isNull()
     */
//@ requires reportMatcher(new InstanceOf(Double.class, "<any double>"));
//@ ensures \result == 0;
...
//@ ensures \result == 0;
     ...
     * @see #isNull()
     */
//@ requires reportMatcher(new InstanceOf(String.class, "<any string>"));
//@ ensures \result!= null;
...
//@ ensures \result == (value ==);
     ...
     */
//@ requires value!= 0;
//@ ensures reportMatcher(new Equals(value));
...
//@ ensures \result!= null;
     ...
     * @return <code>null</code>.
     */
//@ ensures \result == null || \result.equals(value);
...
//@ ensures \result == null;
     ...
     * @since 4.11.0
     */
//@ ensures \result == null || \result.equals(notNull(type));
     ...
     * @return <code>null</code>.
     */
//@ ensures \result == null || \result == clazz;
...
//@ ensures \result == argument;
     ...
     */
//@ requires matcher!= null;
//@ ensures \result == matcher.matches();
