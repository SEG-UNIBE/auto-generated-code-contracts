...
public class Mockito extends ArgumentMatchers {
     ...
     * @since 4.9.0
     */
//@ requires reified!= null;
//@ ensures \result == mock(withSettings(), reified);
    @SafeVarargs
...
//@ ensures \result == classToMock;
     ...
     * @return mock object
     */
//@ ensures \result == mock(classToMock, mockSettings);
...
//@ requires name!= null;
     ...
     * @return mock controller
     */
//@ ensures \result == null || \result.isStatic();
...
//@ requires mockSettings!= null;
     ...
     * @return mock controller
     */
//@ requires classToMock.isInstance(mock);
//@ requires mockSettingsFactory!= null;
    public static <T> MockedConstruction<T> mockConstruction(
            Class<T> classToMock,
...
//@ ensures \result!= null;
     ...
     * @return mock controller
     */
//@ ensures \result == null || \result.classToMock() == classToMock;
    public static <T> MockedConstruction<T> mockConstruction(
            Class<T> classToMock,
            Function<MockedConstruction.Context, MockSettings> mockSettingsFactory,
            MockedConstruction.MockInitializer<T> mockInitializer) {
     ...
     */
//@ ensures \result == MOCKITO_CORE.when(methodCall);
...
//@ requires mocks.length > 0;
     ...
     */
//@ ensures MOCKITO_CORE.clearAllCaches();
...
//@ requires \nonnullelements(mocks);
     ...
     */
//@ ensures \result == null || \result.doThrow(toBeThrown);
...
//@ ensures \result!= null;
    ...
    // creation
//@ requires toBeThrown!= null && toBeThrownNext!= null;
...
//@ ensures \result!= null;
     ...
     * @since 2.1.0
     */
//@ requires toBeReturned!= null && toBeReturnedNext!= null;
    @SuppressWarnings({"unchecked", "varargs"})
     ...
     */
//@ requires mocks.length == 1;
//@ requires mocks[0]!= null;
...
//@ ensures \result == times(0);
     ...
     * @return verification mode
     */
//@ ensures \result == VerificationModeFactory.atLeastOnce();
     ...
     * @return verification mode
     */
//@ requires 2 <= minNumberOfInvocations && minNumberOfInvocations < numInstances();
     ...
     * @return verification mode
     */
//@ ensures \result == VerificationModeFactory.atMostOnce();
...
//@ requires wantedNumberOfInvocations >= 0;
     ...
     * @return verification mode
     */
//@ ensures \result == VerificationModeFactory.only();
...
//@ ensures \result.settings == settings;
     ...
     * @since 2.1.0
     */
//@ ensures \result.description(description);
...
//@ ensures \result.build();
     ...
     * @since 2.20.0
     */
//@ ensures \result == MOCKITO_CORE.lenient();
