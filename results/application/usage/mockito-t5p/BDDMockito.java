...
//@ ensures \result!= null // sample code
...
//@ ensures \result!= null;
     ...
     * @since 1.8.0
     */
//@ ensures \result.methodCall == methodCall;
...
//@ ensures \result == verify(mock);
         ...
         * @since 1.10.5
         */
//@ ensures \result == verify(mock, mode);
...
//@ requires mock!= null;
         ...
         * @since 2.1.0
         */
//@ requires inOrder!= null && mode!= null;
...
//@ ensures \result!= null // stubber should be created
//@ ensures \result instanceof BDDStubberImpl;
...
//@ ensures \result!= null;
     ...
     * @since 1.9.0
     */
//@ ensures \result!= null // source: \result.shouldThrow()
...
//@ ensures \result!= null && \result.isReturnable(\toBeReturned, toBeReturnedNext);
    @SuppressWarnings({"unchecked", "varargs"})
