...
//@ requires mockMethod!= null;
//@ requires delegateMethod!= null;
    @Override
...
//@ requires superType!= null && subType!= null;
//@ ensures \result <==> superType.equals(subType) || superType.isAssignableFrom(subType);
