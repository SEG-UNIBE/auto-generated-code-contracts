...
//@ requires invocation!= null && invocation.getMock()!= null;
    @Override
...
//@ requires invocation!= null && returnTypeGenericMetadata!= null;
...
//@ ensures \result.settings() == parentMockSettings;
...
//@ ensures \result == mockSettings.serializable(parentMockSettings.getSerializableMode());
...
//@ requires returnTypeGenericMetadata!= null;
...
//@ ensures \result == returnTypeGenericMetadata;
        @Override
        protected GenericMetadataSupport actualParameterizedType(Object mock) {
...
//@ ensures \old(mock.answer(invocation)) == \old(mock.answer(invocation));
        @Override
        public Object answer(InvocationOnMock invocation) throws Throwable {
            return mock;
        }
...
//@ ensures \result == LazyHolder.MOCKITO_CORE;
    private static MockitoCore mockitoCore() {
        return LazyHolder.MOCKITO_CORE;
    }

//@ ensures \result == LazyHolder.DELEGATE;
