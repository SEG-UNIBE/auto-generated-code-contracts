...
//@ requires value!= null && (\forall int i; 0 <= i && i < values.length; values[i]!= null);
//@ ensures \result == thenReturn(value);
    @Override
...
//@ ensures \result.isSuccessful();
    private OngoingStubbing<T> thenThrow(Throwable throwable) {
        return thenAnswer(new ThrowsException(throwable));
    }

//@ ensures \result == null || \result.thenThrow(throwables);
    @Override
...
//@ ensures \result.isSuccessful() == (throwableType == null) || \result.isFailed();
    @Override
...
//@ ensures \result.isSuccessful() ==> (toBeThrown == null || nextToBeThrown == null);
    @Override
...
//@ requires this.strongMockRef!= null;
    @Override
