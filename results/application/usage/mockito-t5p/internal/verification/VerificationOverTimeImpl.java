...
//@ requires verificationMode!= null;
//@ ensures \result.valid(pollingPeriodMillis, timer.duration(), verificationMode, returnOnSuccess);
...
//@ ensures \result == returnOnSuccess;
    public boolean isReturnOnSuccess() {
        return returnOnSuccess;
    }

//@ ensures \result == pollingPeriodMillis;
