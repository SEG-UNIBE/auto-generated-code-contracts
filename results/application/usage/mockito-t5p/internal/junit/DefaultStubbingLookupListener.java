...
//@ requires event!= null
//@ requires currentStrictness!= null;
    @Override
...
//@ requires invocation!= null // TODO(b/14067024)
//@ requires stubbings!= null // TODO(b/14067024)
     ...
     */
//@ ensures currentStrictness == null;
//@ ensures this.currentStrictness == null;
//@ requires currentStrictness!= null;
//@ ensures currentStrictness == currentStrictness;
     ...
     */
//@ ensures \result == mismatchesReported;
