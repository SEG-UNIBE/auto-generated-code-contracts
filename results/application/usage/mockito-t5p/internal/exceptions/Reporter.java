...
//@ ensures \result.argumentIsNotAMock(mock);
...
//@ requires \nonnullelements(mockOne, mockTwo);
...
//@ requires mockOne!= null && mockTwo!= null;
...
//@ requires mockOne!= null;
//@ requires mockTwo!= null;
...
//@ requires 2 <= expectedMatchersCount && expectedMatchersCount < recordedMatchers.size();
...
//@ requires additionalMatcherName!= null;
...
//@ requires actualInvocation!= null
//@ requires matchableInvocation!= null
     ...
     */
//@ requires actualInvocation!= null && matchableInvocation!= null;
//@ requires messageBuilder!= null;
...
//@ requires wanted!= null && previous!= null;
...
//@ requires wantedCount > 0 && actualCount > 0;
...
//@ requires invocations.size() > wantedCount + actualCount;
...
//@ requires wanted!= null && invocations!= null;
...
//@ requires wanted!= null && allLocations!= null;
...
//@ requires expectedType!= null;
//@ requires actualType!= null;
//@ requires methodName!= null;
...
//@ requires actualType!= null;
//@ requires methodName!= null;
//@ ensures \result.expectedType == expectedType;
//@ ensures \result.actualType == actualType;
//@ ensures methodName == \old(methodName) + "();
...
//@ requires 2 <= maxNumberOfInvocations && maxNumberOfInvocations < numInstances();
//@ requires 0 <= foundSize && foundSize < numInstances();
...
//@ requires wrongType.isInterface();
...
//@ requires wrongType.isAssignableFrom(extraInterfaces());
...
//@ requires \nonnullelements(extraInterfaces());
...
//@ ensures \result == null || \result.mockedType() == mockedType;
//@ ensures \result!= null && \result.spiedInstance() == spiedInstance;
...
//@ requires mockOfConcreteClass!= null;
...
//@ requires undesiredAnnotationOne!= null && undesiredAnnotationTwo!= null;
...
//@ requires listenerThrowable!= null;
...
//@ requires field!= null && matchingMock!= null;
...
//@ requires mockCandidates.size() > 0;
...
//@ ensures \result == null || \result.mockedType() == mockedType;
//@ ensures \result!= null && \result.delegatedInstance() == delegatedInstance;
...
//@ ensures \result == null || \result.isSpy() || \result.isDelegated();
...
//@ requires invocation!= null && expectedType!= null && actualType!= null;
...
//@ requires mockMethod!= null && delegateMethod!= null;
...
//@ requires testClass!= null;
//@ requires unnecessaryStubbings.size() > 0;
...
//@ requires class_init_token(NetByteBuddy.class) == true;
