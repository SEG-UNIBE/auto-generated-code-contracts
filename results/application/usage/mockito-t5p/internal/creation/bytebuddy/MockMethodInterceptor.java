...
//@ requires weakReferenceHatch.get()!= null;
...
//@ ensures handler == handler;
//@ ensures handler!= null;
    public MockHandler getMockHandler() {
        return handler;
    }

//@ ensures \result == serializationSupport;
