...
//@ requires mockedType!= null;
//@ requires interfaces!= null;
//@ requires serializableMode!= null;
//@ requires stripAnnotations!= null;
//@ ensures \result.mockedType == mockedType;
//@ ensures \result.interfaces == interfaces;
//@ ensures \result.serializableMode == serializableMode;
//@ ensures \result.stripAnnotations == stripAnnotations;
