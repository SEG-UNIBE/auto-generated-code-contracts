...
//@ ensures \result == (INSTRUMENTATION.isModifiableClass(type) &&!EXCLUDES.contains(type));
            @Override
...
//@ requires type!= null;
//@ requires mockedConstruction!= null;
    @Override
...
//@ requires init(this.type,?context) &*& context!= null;
//@ ensures this.type == type;
//@ requires init(this.type, context) &*& context!= null;
        @Override
        public void enable() {
...
//@ requires parameterTypeNames!= null;
