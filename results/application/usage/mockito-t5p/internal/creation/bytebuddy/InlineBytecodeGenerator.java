...
//@ requires canRead == null;
//@ requires redefineModule!= null;
...
//@ requires features.mockedType!= null;
...
//@ requires!mocked.contains(type);
//@ requires!flatMocked.contains(type);
...
//@ requires enabled;
//@ ensures not_modified == this.not_modified;
//@ requires enabled;
//@ ensures this.enabled == enabled;
//@ requires enabled;
//@ ensures not_modified == this.not_modified;
...
//@ requires instrumentedType!= null;
        @Override
