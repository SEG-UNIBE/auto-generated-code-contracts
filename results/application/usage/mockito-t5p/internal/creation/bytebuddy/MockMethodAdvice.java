...
//@ ensures \result == null || \result.isEmpty() ==> \old(mock.getMockList()) == null;
//@ ensures \result!= null ==> \old(mock.getMockList())!= null;
...
//@ ensures \result ==!\old(instance.equals(origin.getDeclaringClass()))
    @Override
...
//@ requires origin!= null;
//@ requires instance!= null;
//@ requires (\forall int i; 0 <= i && i < arguments.length; 0 <= arguments[i] && arguments[i] < instance.getClass());
...
//@ requires implementationContext!= null;
                        @Override
...
//@ requires selected!= null && instrumentedMethod!= null;
                        @Override
...
//@ ensures \result == (\exists String id; id!= null; self!= null);
        @SuppressWarnings("unused")
        @Advice.OnMethodEnter(skipOn = Advice.OnNonDefaultValue.class)
...
//@ ensures \result == (\exists String identifier;
...
//@ requires objectInputStream!= null;
