...
//@ requires type!= null;
//@ ensures \result == null || \result.isConstructor();
...
//@ ensures \result == Modifier.isPrivate(modifiers) && type.getEnclosingClass()!= null;
...
//@ requires field!= null;
//@ requires (\forall Class<?> c; false == c.isAnnotationPresent(annotation); false == u.isAnnotationPresent(annotation));
