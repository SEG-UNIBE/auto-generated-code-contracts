...
//@ requires lhs!= null && rhs!= null;
     ...
     * @return <code>true</code> if the two Objects have tested equals.
     */
//@ requires excludeFields!= null && \nonnullelements(excludeFields);
...
//@ requires lhs!= null && rhs!= null;
     ...
     */
//@ requires lhs!= null && rhs!= null;
//@ requires (\forall int i; 0 <= i && i < testTransients;!rhs.equals(lhs[i]));
...
//@ requires \nonnullelements(excludeFields);
     ...
     * @since 2.1.0
     */
//@ ensures isEquals == (\old(isEquals) && superEquals);
     ...
     */
//@ requires lhs!= null && rhs!= null;
//@ ensures isEquals == (\old(isEquals) && lhs.equals(rhs));
     ...
     * @return EqualsBuilder - used to chain calls.
     */
//@ requires lhs!= Long.MIN_VALUE;
//@ requires rhs!= Long.MIN_VALUE;
//@ ensures isEquals == (\old(isEquals) && lhs == rhs);
     ...
     * @return EqualsBuilder - used to chain calls.
     */
//@ requires lhs!= Integer.MIN_VALUE;
//@ requires rhs!= Integer.MIN_VALUE;
//@ ensures isEquals == (\old(isEquals) == rhs);
...
//@ ensures isEquals == (\old(isEquals) == rhs);
     ...
     */
//@ requires lhs!= null && rhs!= null;
//@ ensures \result.isEquals(lhs == rhs && \result.isEquals);
...
//@ requires lhs!= Integer.MIN_VALUE;
//@ requires rhs!= Integer.MIN_VALUE;
//@ ensures isEquals == (lhs == rhs);
//@ ensures!isEquals == (lhs == null && rhs == null);
...
//@ ensures isEquals == (\old(isEquals) && lhs == rhs);
     ...
     * @return EqualsBuilder - used to chain calls.
     */
//@ requires lhs.length == rhs.length && isEquals == true;
//@ requires \nonnullelements(lhs);
//@ requires \nonnullelements(rhs);
    public EqualsBuilder append(Object[] lhs, Object[] rhs) {
        if (!isEquals) {
