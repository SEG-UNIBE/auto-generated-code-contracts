...
//@ ensures \result.size() == invocations.size();
...
//@ requires inv(inv(this));
    public Method getMethod() {
        return invocation.getMethod();
    }

//@ requires inv(this.invocation);
    @Override
...
//@ requires invocation!= null && candidate!= null;
    @Override
     ...
     */
//@ requires getMethod()!= null;
//@ requires candidate.getMethod()!= null;
    @Override
...
//@ requires matchers!= null;
//@ requires 0 <= invocation.invocationId && invocation.invocationId < numInstances();
    @Override
...
//@ ensures \result == (matcher instanceof CapturesArguments);
...
//@ requires (actual!= null && \fresh(actual.getArgumentList()));
    @SuppressWarnings({"rawtypes", "unchecked"})
