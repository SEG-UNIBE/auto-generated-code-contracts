...
//@ requires unused!= null && unstubbed!= null;
    @Override
...
//@ requires additions!= null;
//@ requires target.size() < additions.size();
//@ ensures \result.size() < additions.size();
