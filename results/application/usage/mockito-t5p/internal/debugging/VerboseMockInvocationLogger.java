...
//@ requires initToken!= null && token!= initToken;
//@ requires name!= null && token!= name;
//@ requires arity >= 0;
//@ ensures initToken == token;
//@ ensures name == name;
//@ ensures arity == arity;
    @Override
...
//@ requires methodInvocationReport!= null;
