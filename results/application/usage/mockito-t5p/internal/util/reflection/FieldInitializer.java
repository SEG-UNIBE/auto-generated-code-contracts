...
//@ requires field.getType().isInterface();
...
//@ requires field!= null && fieldOwner!= null;
...
//@ requires constructorA.getParameterTypes().length == constructorB.getParameterTypes().length;
                    @Override
