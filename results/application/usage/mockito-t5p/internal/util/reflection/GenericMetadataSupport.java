...
//@ ensures \fresh(\result);
     ...
     */
//@ ensures \result == rawExtraInterfaces().length > 0;
...
//@ requires ParameterizedType!= null;
//@ requires this.parameterizedType!= null;
...
//@ requires typeParameters == null || typeParameters.length == 1;
//@ requires isGeneric == true;
//@ requires typeParameters[0]!= null;
...
//@ requires isGeneric == true;
//@ requires firstParam!= null && secondParam!= null;
...
//@ ensures firstBound() == p;
//@ ensures interfaceBounds() == i;
        @Override
...
//@ requires true;
//@ ensures \result == wildcard.hashCode();
        @Override
        public int hashCode() {
            return wildcard.hashCode();
        }

//@ ensures firstBound() == p.firstBound();
//@ ensures interfaceBounds() == p.interfaceBounds();
        @Override
        public String toString() {
            return "{firstBound=" + firstBound() + ", interfaceBounds=[]}";
        }

//@ ensures \result == wildcard;
