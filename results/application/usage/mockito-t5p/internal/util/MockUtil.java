...
//@ ensures \result == null || \result.isDefault();
...
//@ ensures \result <==> getMockMaker(mockMaker).isTypeMockable(type);
...
//@ requires mock!= null;
//@ ensures  \result == (getMockHandlerOrNull(mock)!= null);
...
//@ ensures getMockName(mock) == newName;
//@ ensures \old(getMockName(mock)) == newName;
...
//@ requires type.isInstance(result);
...
//@ requires type.isInstance(mockInitializer.getMockType());
