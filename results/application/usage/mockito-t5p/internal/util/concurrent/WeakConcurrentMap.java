...
//@ requires this.target!= null;
     ...
     */
//@ ensures \result == null || \result == key.value();
...
//@ requires 0 <= first;
//@ requires 0 <= toCopy;
//@ requires first + toCopy <= source.numEntries();
    @Override
...
//@ requires nextEntry!= null;
//@ requires nextKey!= null;
...
//@ requires ((this.entry!= null) && (this.entry.getValue()!= null));
        @Override
        public V getValue() {
