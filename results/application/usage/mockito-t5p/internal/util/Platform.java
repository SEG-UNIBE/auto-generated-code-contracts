...
//@ ensures \result ==!\exists<java.lang.String>("android");
    public static boolean isAndroid() {
        return System.getProperty("java.vendor", "").toLowerCase(Locale.US).contains("android");
    }

//@ ensures \result == Boolean.getBoolean("org.mockito.mock.android");
...
//@ requires vmName1!= null && vmName2!= null;
//@ requires warnMessage1!= null && warnMessage2!= null;
