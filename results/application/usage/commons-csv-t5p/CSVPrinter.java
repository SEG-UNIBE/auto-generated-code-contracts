...
//@ ensures!isOpen;
     ...
     * @since 1.6
     */
//@ requires flush || format.getAutoFlush();
...
//@ requires this.appendable!= null;
     ...
     */
//@ requires value!= null;
//@ ensures newRecord == (format.isNewRecord() || format.isPrintable(value));
