...
//@ ensures \result == copy(input, output, _);
...
//@ requires input!= null;
//@ requires output!= null;
//@ requires (\forall int i; 0 <= i && i < buffer.length; buffer[i] == \old(buffer[i]));
     ...
     */
//@ ensures \result == null || \result.getThrowable() == throwable;
