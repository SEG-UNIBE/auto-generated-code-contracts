...
final class ExtendedBufferedReader extends BufferedReader {
     ...
     */
//@ ensures closed == true;
//@ ensures lastChar == END_OF_STREAM;
    @Override
...
//@ ensures \result == eolCounter + 1;
     ...
     */
//@ requires str!=null;
//@ ensures lastChar == str.length() - 1;
//@ requires 0 <= str.length() && str.length() <= lastChar;
//@ ensures \result == lastChar;
    int getLastChar() {
        return lastChar;
    }
...
//@ ensures \result == closed;
     ...
     *             If an I/O error occurs
     */
//@ requires super.markSupported(currentThread);
//@ ensures true;
...
//@ requires position < 0;
//@ ensures position == 0;
//@ requires lastChar!= END_OF_STREAM;
//@ ensures position == 0;
//@ requires lastChar!= CR;
//@ ensures position == 0;
//@ requires lastChar!= LF;
//@ ensures position == 0;
//@ requires lastChar!= END_OF_STREAM;
    @Override
