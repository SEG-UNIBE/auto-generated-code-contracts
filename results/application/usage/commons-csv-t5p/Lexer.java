...
//@ requires firstEol!= null;
    String getFirstEol(){
        return firstEol;
    }

//@ ensures \result == reader.isClosed();
    boolean isClosed() {
        return reader.isClosed();
    }

//@ requires ch!= commentStart;
...
//@ ensures!isLastTokenDelimiter == \result;
     ...
     */
//@ ensures \result <==> (ch == END_OF_STREAM);
...
//@ ensures \result == (ch == escape || ch == quoteChar || ch == commentStart);
    private boolean isMetaChar(final int ch) {
        return ch == escape || ch == quoteChar || ch == commentStart;
    }

//@ ensures \result <==> ch == quoteChar;
     ...
     */
//@ ensures \result <==> (ch == LF || ch == CR || ch == UNDEFINED);
    boolean isStartOfLine(final int ch) {
        return ch == LF || ch == CR || ch == UNDEFINED;
    }

//@ ensures \result == c == null? DISABLED : c.charValue();
