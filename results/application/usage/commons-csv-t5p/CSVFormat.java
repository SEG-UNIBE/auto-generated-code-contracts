...
//@ ensures \result!= null;
         ...
         */
//@ ensures allowDuplicateHeaderNames() == duplicateHeaderMode();
        @Deprecated
         ...
         * @return This instance.
         */
//@ ensures allowMissingColumnNames == allowMissingColumnNames;
         ...
         * @return This instance.
         */
//@ ensures autoFlush == \old(autoFlush);
         ...
         */
//@ ensures getCommentMarker() == commentMarker;
...
//@ ensures commentMarker == null;
         ...
         * @return This instance.
         */
//@ ensures \result.delimiter == delimiter;
...
//@ ensures this.delimiter == delimiter;
         ...
         * @since 1.10.0
         */
//@ ensures duplicateHeaderMode == null;
//@ ensures duplicateHeaderMode == duplicateHeaderMode;
         ...
         * @throws IllegalArgumentException thrown if the specified character is a line break
         */
//@ ensures \result.escape(escapeCharacter);
         ...
         * @throws IllegalArgumentException thrown if the specified character is a line break
         */
//@ ensures this.escapeCharacter == escapeCharacter;
         ...
         * @return This instance.
         */
//@ requires headerEnum!= null;
//@ requires \nonnullelements(header);
...
//@ requires metaData!= null;
         ...
         * @throws SQLException SQLException if a database access error occurs or this method is called on a closed result set.
         */
//@ requires resultSetMetaData!= null;
...
//@ ensures headers == CSVFormat.clone(header);
         ...
         * @return This instance.
         */
//@ requires headerComments!= null;
//@ ensures  headerComments == null;
//@ requires headerComments.length == 0;
//@ ensures  headerComments == null;
         ...
         */
//@ requires headerComments!= null;
//@ ensures  headerComments == headerComments;
         ...
         * @return This instance.
         */
//@ ensures ignoreEmptyLines == ignoreEmptyLines;
         ...
         * @return This instance.
         */
//@ ensures ignoreHeaderCase == ignoreHeaderCase;
         ...
         * @return This instance.
         */
//@ ensures ignoreSurroundingSpaces == \old(ignoreSurroundingSpaces);
         ...
         * @return This instance.
         */
//@ ensures nullString == nullString;
//@ ensures quotedNullString == \old(quotedNullString) + nullString + quoteCharacter;
         ...
         * @return This instance.
         */
//@ ensures \result.getQuote() == quoteCharacter;
         ...
         * @return This instance.
         */
//@ ensures this.quoteCharacter == quoteCharacter;
...
//@ ensures quoteMode == quoteMode;
         ...
         * @return This instance.
         */
//@ ensures recordSeparator == null;
//@ ensures this.recordSeparator == recordSeparator;
...
//@ ensures this.recordSeparator == recordSeparator;
         ...
         * @return This instance.
         */
//@ ensures skipHeaderRecord == skipHeaderRecord;
         ...
         * @return This instance.
         */
//@ ensures trailingDelimiter == \old(trailingDelimiter);
...
//@ ensures (\fresh(\result));
     ...
     */
//@ ensures \result <==> Objects.requireNonNull(source, "source").indexOf(searchCh) >= 0;
...
//@ ensures \result <==> (value == null || value.trim().isEmpty());
...
//@ ensures \result <==> (c == LF || c == CR);
     ...
     */
//@ ensures \result == (c!= null && isLineBreak(c.charValue()));
    private static boolean isLineBreak(final Character c) {
        return c != null && isLineBreak(c.charValue());
    }

    /** Same test as in as {@link String#trim()}. */
//@ ensures \result <==> (ch == SP);
    ...
    /** Same test as in as {@link String#trim()}. */
//@ requires pos >= 0;
//@ requires pos <= charSequence.length();
     ...
     */
//@ requires delimiter!= '\n';
//@ ensures \result.header == null || \result.header.equals("");
//@ ensures \result.duplicateHeader == null || \result.duplicateHeader.equals("");
...
//@ requires values!= null && \nonnullelements(values);
     ...
     */
//@ ensures \result == duplicateHeaderMode;
    @Deprecated
     ...
     */
//@ ensures \result == allowMissingColumnNames;
...
//@ ensures \result == duplicateHeaderMode;
     ...
     */
//@ ensures \result == escapeCharacter;
     ...
     */
//@ ensures (\forall int i; 0 <= i && i < headers.length; headers[i] == null);
//@ ensures (\forall String s; 0 <= s && s < body.length; body[i] == null);
...
//@ requires headerComments!= null;
     ...
     */
//@ ensures \result == ignoreEmptyLines;
     ...
     * @since 1.3
     */
//@ ensures \result == ignoreHeaderCase;
     ...
     */
//@ ensures \result == ignoreSurroundingSpaces;
...
//@ ensures \result!= null;
     ...
     */
//@ ensures \result == skipHeaderRecord;
     ...
     * @since 1.3
     */
//@ ensures \result == trailingDelimiter;
...
//@ requires headerComments!= null;
     ...
     */
//@ ensures \result == commentMarker!= null;
...
//@ requires startIndex + delimiterLength <= charSeq.length();
//@ requires delimiter!= null;
//@ requires (\forall int i; 0 <= i && i < delimiter.length; 0 <= delimiter[i] && delimiter[i] < charSeq.length());
...
//@ ensures \result == escapeCharacter;
     ...
     */
//@ ensures \result == (nullString!= null);
...
//@ requires appendable!= null;
    ...
    // the original object is needed so can check for Number
//@ requires charSeq!= null;
//@ requires start >= 0 && start <= charSeq.length();
//@ requires pos >= 0 && pos <= charSeq.length();
...
//@ ensures \result!= null;
     ...
     */
//@ requires delimiter!= null;
//@ requires quoteCharacter!= null;
//@ requires escapeCharacter!= null;
//@ requires commentMarker!= null;
//@ requires quoteMode!= QuoteMode.NONE;
     ...
     */
//@ ensures \result.duplicateHeaderMode() == DuplicateHeaderMode.ALLOW_ALL;
    @Deprecated
...
//@ ensures \result.duplicateHeaderMode() == DuplicateHeaderMode.ALLOW_ALL;
     ...
     */
//@ ensures \result.getAllowMissingColumnNames() == true;
    @Deprecated
     ...
     */
//@ ensures \result.getAllowMissingColumnNames() == allowMissingColumnNames;
    @Deprecated
...
//@ ensures \result.getAutoFlush();
     ...
     */
//@ ensures \result.commentMarker() == commentMarker;
    @Deprecated
...
//@ ensures \result.getDelimiter() == delimiter;
     ...
     */
//@ ensures \result.getEscape() == escape;
    @Deprecated
...
//@ ensures \result.getHeader() == true;
     ...
     */
//@ ensures \result.setHeader(headerEnum);
    @Deprecated
...
//@ ensures \resultSet.next() == true;
     ...
     */
//@ ensures \resultSetMetaData!= null;
    @Deprecated
     ...
     */
//@ ensures \result.getHeader() == header;
    @Deprecated
     ...
     */
//@ ensures \result.setHeaderComments(headerComments);
    @Deprecated
     ...
     */
//@ ensures \result.setIgnoreEmptyLines(false);
    @Deprecated
     ...
     */
//@ ensures \result.getIgnoreEmptyLines() == ignoreEmptyLines;
    @Deprecated
     ...
     */
//@ ensures \result.setIgnoreHeaderCase(false);
    @Deprecated
     ...
     */
//@ ensures \result.isIgnoreHeaderCase() == ignoreHeaderCase;
    @Deprecated
     ...
     */
//@ ensures \result.getIgnoreSurroundingSpaces() == true;
    @Deprecated
     ...
     */
//@ ensures \result.isIgnoreSurroundingSpaces() == ignoreSurroundingSpaces;
    @Deprecated
     ...
     */
//@ ensures \result.getNullString() == nullString;
    @Deprecated
     ...
     */
//@ ensures \result.getQuote() == quoteChar;
    @Deprecated
...
//@ ensures \result.getQuote() == quoteChar;
     ...
     */
//@ ensures \result.getQuoteMode() == quoteMode;
    @Deprecated
     ...
     */
//@ ensures \result.setRecordSeparator(recordSeparator);
    @Deprecated
...
//@ ensures \result.setRecordSeparator(recordSeparator);
     ...
     */
//@ ensures \result.getSkipHeaderRecord();
    @Deprecated
...
//@ ensures \result.getSkipHeaderRecord();
     ...
     */
//@ ensures \result.setRecordSeparator(System.lineSeparator());
    @Deprecated
     ...
     */
//@ ensures \result.setTrailingDelimiter(false);
    @Deprecated
     ...
     */
//@ ensures \result.setTrailingDelimiter(trailingDelimiter);
    @Deprecated
